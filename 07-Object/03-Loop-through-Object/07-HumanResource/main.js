...
function searchEmployee(name){
    if(employees[name] == undefined){
        ...
        return `Name: ${name}, salary: ${employees[name].salary}, address: ${employees[name].address.district},province :${employees[name].address.province}`
    }
}


console.log(searchEmployee('john')
)